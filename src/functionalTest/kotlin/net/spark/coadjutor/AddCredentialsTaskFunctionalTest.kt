...
class AddCredentialsTaskFunctionalTest {
    ...
    internal fun setUpSuite(@TempDir testDir: File) {
        project = TestProjectBuilder
            .newProject(testDir, BuildScriptLanguage.KOTLIN)
    ...
    fun shouldUseRepoMasterPasswordWhenExist() {
        ...
        val result = Runner.run(project, "addCredentials", "--repo=example", "--username=admin", "--password=secret", "--use-repo-master-pass")
